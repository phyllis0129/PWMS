...
namespace PWMS.PerForm
{
    public partial class F_WordPad : Form
    {
        ...
        private void F_WordPad_Load(object sender, EventArgs e)
        {
            ...
            Word_Add.Enabled = true;
            Word_Amend.Enabled = true;
            Word_Cancel.Enabled = false;
            Word_Save.Enabled = false;
        }
        ...
        private void Word_Add_Click(object sender, EventArgs e)
        {
            ...
            Word_S = 1;
            Word_Add.Enabled = true;
            Word_Amend.Enabled = false;
            Word_Cancel.Enabled = true;
            Word_Save.Enabled = true;
        }
